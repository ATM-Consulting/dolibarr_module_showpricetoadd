 ...
 */
class showpricetoaddbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "showpricetoadd@showpricetoadd";
    public $boxlabel;
    public $depends = array("showpricetoadd");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/showpricetoadd/class/showpricetoadd.class.php";
